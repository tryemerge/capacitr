  ...
  apps: [
    {
      ...
      env: loadEnvFile(
        "/Users/the_dusky/code/sandbox/capacitr/apps/docs/.env.local",
      ),
      watch: false,
      autorestart: true,
      max_restarts: 3,
    },
    {
      ...
      env: loadEnvFile(
        "/Users/the_dusky/code/sandbox/capacitr/apps/launchpad/.env.local",
      ),
      watch: false,
      autorestart: true,
      max_restarts: 3,
    },
    {
      ...
      env: loadEnvFile(
        "/Users/the_dusky/code/sandbox/capacitr/apps/sim/.env.local",
      ),
      watch: false,
      autorestart: true,
      max_restarts: 3,
