---
title: "Whitepaper Version History"
---
...
- Project guarantee visible on-chain → traders buy token → token price rises → entry cost increases
- Governance quality scales with project success

**New section: Payout Mechanics**
- Speaking pool: winner-take-all to top-voted contributor
- Voting pool: splits among voters who backed winner
...
## v0.0.16 — 2026-02-22
**Phase 4: Qualitative Work Governance — forward-looking vision** — [Read archived version](/versions/whitepaper/v0-0-16)
...
- Sybil resistance inherited from Classes 1 and 2
...
- All "Work → Emmitt → Earn" references removed
...
- Each class follows parallel structure: Definition → Incentive Structure → The Problems → Why This Is Acceptable
...
- New subsection: "The Hard Problems" — 7 attack vectors laid out before solutions:
  1. Sybil attacks
  2. Self-dealing
  3. Quality verification
  4. Spam and resource exhaustion
  5. Rate gaming
  6. Collusion
...
- Two exit paths: sell on EmPool (2 weeks) or redeem against LP (3 weeks)
...
- Pool is an active LP position that compounds (Beefy-style, protocol-native)
...
- "EmMittr is simple, and it is extremely powerful."
...
- Scenario A (INSIGHT): Humans pay, earn emmissions
- Scenario B (AGENT): Agents work for free, earn emmissions. No human required.
...
- New opening section "The Agentic Economy" with real data
...
- "Promotion Gap" → "Participation Gap"
- Removed all pump.fun references
- Key shift: We incentivize Work. Ease of use is a retort to the complexity objection, not the headline.
...
- Three tiers: Default → Custom → Autonomous
- New Part VI: "Why Agents Change Everything"
...
- "There is no oracle. The project is the authority."
- Contract architecture: 10 → 8 contracts
