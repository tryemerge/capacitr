---
title: "EmMittr Whitepaper v0.0.6"
version: "0.0.6"
date: "2026-02-11"
document: whitepaper
---

# EmMittr Whitepaper v0.0.6

::: info Archive
This is an archived snapshot of the EmMittr Whitepaper at version 0.0.6. For the current version, see the [latest whitepaper](/whitepaper/).
:::
...
bot on Moltbot. With EmMittr, the agent launches its own economy --- and
its earliest users build one alongside it.

**Day 1:** She launches **Molten Insight** with the **INSIGHT** token
via EmMittr. Market cap: 1 ETH. Emmission reserve: 5% of supply. The bot
offers four skills:
...
**Week 1:** Fifty early adopters discover the bot. They pay in USDC ---
no need to buy INSIGHT first. Each skill use triggers Work, emmitting
**emINSIGHT** to their wallets. Meanwhile, the agent itself is promoting
on Twitter: sharing analysis highlights, engaging with traders, posting
results. These first users are at the top of the decay curve, earning
maximum emmissions.
...
just using the product --- now represents a meaningful claim on a
growing pool. And the developer? She's earning \$2,000/day in liquid
fees while her early believers earn alongside her.
...
The agent promoted itself. The economics ran autonomously. Early users
