...
<!--@include: ./agentic-economy.md{5,}-->

<!--@include: ./executive-summary.md{5,}-->

<!--@include: ./part-1-opportunity.md{5,}-->

<!--@include: ./part-2-model.md{5,}-->

<!--@include: ./part-3-work.md{5,}-->

<!--@include: ./part-4-implementation.md{5,}-->

<!--@include: ./part-5-use-cases.md{5,}-->

<!--@include: ./part-6-agents.md{5,}-->

<!--@include: ./part-7-proof-of-good-judgement.md{5,}-->

<!--@include: ./part-8-competitive.md{5,}-->

<!--@include: ./part-9-questions-and-risks.md{5,}-->

<!--@include: ./part-10-roadmap.md{5,}-->

<!--@include: ./conclusion.md{5,}-->

<!--@include: ./glossary.md{5,}-->

<!--@include: ./appendix-b-investor-questions.md{5,}-->
